...
description: 'Continuum AI gives you complete control over the look and feel of your documentation using the docs.json file'
icon: 'gear'
---

Every Continuum AI documentation site needs a `docs.json` file with the core configuration settings. Learn more about the [properties](#properties) below.
...
<ResponseField name="colors" type="Colors">
  ...
  <Expandable title="Colors">
    <ResponseField name="primary" type="string" required>
      ...
      headers, and accents in light mode
    </ResponseField>
    <ResponseField name="light" type="string">
      The primary color for dark mode. Used most often for highlighted
      content, section headers, and accents in dark mode
    </ResponseField>
    <ResponseField name="dark" type="string">
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    The url once you click on the button. Example: `https://continuum-ai.com/contact`
    </ResponseField>
...
<ResponseField name="openapi" type="string | string[]">
  ...
  <CodeGroup>
    ```json Absolute
    "openapi": "https://api.continuumai.technology/openapi.json"
    ```
    ```json Relative
    "openapi": "/openapi.json"
    ```
    ```json Multiple
    "openapi": ["https://api.continuumai.technology/openapi1.json", "/openapi2.json", "/openapi3.json"]
    ```
  </CodeGroup>
...
<ResponseField name="footerSocials" type="FooterSocials">
  ...
  ```json
  {
    "x": "https://x.com/ContinuumAI",
    "website": "https://continuum-ai.com"
  }
  ```
  <Expandable title="FooterSocials">
    ...
    Example: `https://x.com/ContinuumAI`
    </ResponseField>
  </Expandable>
</ResponseField>
