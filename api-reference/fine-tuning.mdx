...
<Steps>
  ...
  <Step title="Use your fine-tuned model">
    ...
    curl -X POST https://api.continuumai.technology/v1/chat/completions \
      ...
      -H "Content-Type: application/json" \
      -d '{
        "model": "ft:continuum-lite:your-project:custom-name:abc123",
...
<ParamField body="model" type="string" required>
  The base model to fine-tune. Supported models: `continuum-lite`, `continuum-ultra`, `continuum-turbo`.
</ParamField>
    ...
    "data": [
      {
        ...
        "model": "continuum-lite",
        "status": "succeeded",
        "fine_tuned_model": "ft:continuum-lite:your-project:legal-assistant:abc123",
  ...
  ```json
  {
    "data": [
      ...
      },
      {
        ...
        "object": "fine_tuning.event",
        "type": "status",
        "message": "Job succeeded. Fine-tuned model: ft:continuum-lite:your-project:legal-assistant:abc123",
