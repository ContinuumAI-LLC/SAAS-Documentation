...
<Steps>
  ...
  <Step title="Upload the training file">
    ...
    ```bash
    curl -X POST https://api.continuum-ai.com/v1/files \
  ...
  <Step title="Create the fine-tuning job">
    ...
    ```bash
    curl -X POST https://api.continuum-ai.com/v1/fine_tuning/jobs \
      -H "Authorization: Bearer sk-proj-..." \
  ...
  <Step title="Monitor training events">
    ...
    ```bash
    curl https://api.continuum-ai.com/v1/fine_tuning/jobs/ftjob_abc123/events \
      -H "Authorization: Bearer sk-proj-..."
    ```
  </Step>
...
response = requests.post(
    "https://api.continuum-ai.com/v1/fine_tuning/jobs",
...
```bash cURL
curl "https://api.continuum-ai.com/v1/fine_tuning/jobs?page=1&pageSize=10" \
  -H "Authorization: Bearer sk-proj-..."
```
...
```bash cURL
curl https://api.continuum-ai.com/v1/fine_tuning/jobs/ftjob_abc123 \
  -H "Authorization: Bearer sk-proj-..."
```

```python Python
response = requests.get(
    "https://api.continuum-ai.com/v1/fine_tuning/jobs/ftjob_abc123",
    headers={"Authorization": "Bearer sk-proj-..."}
)
```
...
```bash cURL
curl "https://api.continuum-ai.com/v1/fine_tuning/jobs/ftjob_abc123/events?pageSize=50" \
  -H "Authorization: Bearer sk-proj-..."
```

```python Python
response = requests.get(
    "https://api.continuum-ai.com/v1/fine_tuning/jobs/ftjob_abc123/events",
    headers={"Authorization": "Bearer sk-proj-..."},
    params={"pageSize": 50}
)
```
