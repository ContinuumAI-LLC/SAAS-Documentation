...
<Tabs>
  <Tab title="Threads">
    ...
    ```bash cURL
    curl -X POST https://api.continuum-ai.com/v1/threads \
    ...
    response = requests.post(
        "https://api.continuum-ai.com/v1/threads",
    ...
    ```bash cURL
    curl https://api.continuum-ai.com/v1/threads?page=1&pageSize=20 \
      -H "Authorization: Bearer sk-proj-..."
    ```
    ...
    ```bash cURL
    curl https://api.continuum-ai.com/v1/threads/thread_abc123def456 \
      -H "Authorization: Bearer sk-proj-..."
    ```

    ```python Python
    response = requests.get(
        "https://api.continuum-ai.com/v1/threads/thread_abc123def456",
        headers={"Authorization": "Bearer sk-proj-..."}
    )
    ```
    ...
    ```bash cURL
    curl -X PATCH https://api.continuum-ai.com/v1/threads/thread_abc123def456 \
      -H "Authorization: Bearer sk-proj-..." \
      -H "Content-Type: application/json" \
      -d '{
        "metadata": {
    ...
    ```bash cURL
    curl -X DELETE https://api.continuum-ai.com/v1/threads/thread_abc123def456 \
      -H "Authorization: Bearer sk-proj-..."
    ```
  ...
  <Tab title="Messages">
    ...
    ```bash cURL
    curl -X POST https://api.continuum-ai.com/v1/threads/thread_abc123def456/messages \
      -H "Authorization: Bearer sk-proj-..." \
      -H "Content-Type: application/json" \
      -d '{
        "role": "user",
    ...
    ```python Python
    response = requests.post(
        "https://api.continuum-ai.com/v1/threads/thread_abc123def456/messages",
        headers={"Authorization": "Bearer sk-proj-..."},
        json={
            "role": "user",
            "content": "What are the top 3 benefits of using a vector database?"
    ...
    ```bash cURL
    curl "https://api.continuum-ai.com/v1/threads/thread_abc123def456/messages?page=1&pageSize=50" \
      -H "Authorization: Bearer sk-proj-..."
    ```
  ...
  <Tab title="Runs">
    ...
    <ParamField body="model" type="string" required>
      The model to use for generation. Examples: `gpt-4o`, `gpt-4o-mini`, `gpt-3.5-turbo`.
    </ParamField>
    ...
    ```bash cURL
    curl -X POST https://api.continuum-ai.com/v1/threads/thread_abc123def456/runs \
      -H "Authorization: Bearer sk-proj-..." \
      -H "Content-Type: application/json" \
      -d '{
        "model": "gpt-4o",
    ...
    ```python Python
    response = requests.post(
        "https://api.continuum-ai.com/v1/threads/thread_abc123def456/runs",
        headers={"Authorization": "Bearer sk-proj-..."},
        json={
            "model": "gpt-4o",
            "temperature": 0.7,
