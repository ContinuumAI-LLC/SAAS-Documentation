...
<Tabs>
  <Tab title="Stores">
    ...
    ```bash cURL
    curl -X POST https://api.continuum-ai.com/v1/vector_stores \
    ...
    response = requests.post(
        "https://api.continuum-ai.com/v1/vector_stores",
    ...
    ```bash cURL
    curl "https://api.continuum-ai.com/v1/vector_stores?page=1&pageSize=20" \
      -H "Authorization: Bearer sk-proj-..."
    ```
    ...
    ```bash cURL
    curl https://api.continuum-ai.com/v1/vector_stores/vs_abc123 \
      -H "Authorization: Bearer sk-proj-..."
    ```

    ```python Python
    response = requests.get(
        "https://api.continuum-ai.com/v1/vector_stores/vs_abc123",
        headers={"Authorization": "Bearer sk-proj-..."}
    )
    ```
  ...
  <Tab title="Store files">
    ...
    ```bash cURL
    curl -X POST https://api.continuum-ai.com/v1/vector_stores/vs_abc123/files \
      -H "Authorization: Bearer sk-proj-..." \
      -H "Content-Type: application/json" \
      -d '{
        "file_id": "file_ghi789"
    ...
    ```python Python
    response = requests.post(
        "https://api.continuum-ai.com/v1/vector_stores/vs_abc123/files",
        headers={"Authorization": "Bearer sk-proj-..."},
    ...
    ```bash cURL
    curl "https://api.continuum-ai.com/v1/vector_stores/vs_abc123/files?status=completed" \
      -H "Authorization: Bearer sk-proj-..."
    ```
    ...
    ```bash cURL
    curl https://api.continuum-ai.com/v1/vector_stores/vs_abc123/files/vsfile_001 \
      -H "Authorization: Bearer sk-proj-..."
    ```

    ```python Python
    response = requests.get(
        "https://api.continuum-ai.com/v1/vector_stores/vs_abc123/files/vsfile_001",
        headers={"Authorization": "Bearer sk-proj-..."}
    )
    ```
    ...
    ```bash cURL
    curl -X DELETE https://api.continuum-ai.com/v1/vector_stores/vs_abc123/files/vsfile_001 \
      -H "Authorization: Bearer sk-proj-..."
    ```
...
<Steps>
  ...
  <Step title="Query with thread runs">
    ...
    ```bash
    curl -X POST https://api.continuum-ai.com/v1/threads/thread_xyz/runs \
      -H "Authorization: Bearer sk-proj-..." \
      -H "Content-Type: application/json" \
      -d '{
        "model": "gpt-4o",
