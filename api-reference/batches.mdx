...
<Steps>
  ...
  <Step title="Create the batch">
    ...
    ```bash
    curl -X POST https://api.continuum-ai.com/v1/batches \
  ...
  <Step title="Download results">
    ...
    ```bash
    curl https://api.continuum-ai.com/v1/files/file_output001/content \
      -H "Authorization: Bearer sk-proj-..." \
...
response = requests.post(
    "https://api.continuum-ai.com/v1/batches",
...
```bash cURL
curl "https://api.continuum-ai.com/v1/batches?page=1&pageSize=10" \
  -H "Authorization: Bearer sk-proj-..."
```
...
```python Python
response = requests.get(
    "https://api.continuum-ai.com/v1/batches/batch_abc123",
    headers={"Authorization": "Bearer sk-proj-..."}
)
```
...
```bash cURL
curl -X POST https://api.continuum-ai.com/v1/batches/batch_abc123/cancel \
  -H "Authorization: Bearer sk-proj-..."
```

```python Python
response = requests.post(
    "https://api.continuum-ai.com/v1/batches/batch_abc123/cancel",
    headers={"Authorization": "Bearer sk-proj-..."}
)
```
