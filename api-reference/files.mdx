...
with open("training_data.jsonl", "rb") as f:
    response = requests.post(
        "https://api.continuum-ai.com/v1/files",
...
```bash cURL
curl "https://api.continuum-ai.com/v1/files?purpose=fine-tune&page=1&pageSize=10" \
  -H "Authorization: Bearer sk-proj-..."
```
...
```bash cURL
curl https://api.continuum-ai.com/v1/files/file_abc123 \
  -H "Authorization: Bearer sk-proj-..."
```

```python Python
response = requests.get(
    "https://api.continuum-ai.com/v1/files/file_abc123",
    headers={"Authorization": "Bearer sk-proj-..."}
)
```
...
```bash cURL
curl -X DELETE https://api.continuum-ai.com/v1/files/file_abc123 \
  -H "Authorization: Bearer sk-proj-..."
```
...
```bash cURL
curl https://api.continuum-ai.com/v1/files/file_abc123/content \
  -H "Authorization: Bearer sk-proj-..." \
...
```python Python
response = requests.get(
    "https://api.continuum-ai.com/v1/files/file_abc123/content",
    headers={"Authorization": "Bearer sk-proj-..."}
)
