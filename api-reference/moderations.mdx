...
<ParamField body="model" type="string" default="continuum-shield" optional>
  The moderation model to use. Currently available: `continuum-shield`, `continuum-shield-latest`.
</ParamField>

<CodeGroup>

```bash cURL
curl -X POST https://api.continuum-ai.com/v1/moderations \
...
response = requests.post(
    "https://api.continuum-ai.com/v1/moderations",
...
def safe_generate(user_message):
    ...
    completion = requests.post(
        "https://api.continuum-ai.com/v1/chat/completions",
        headers={"Authorization": "Bearer sk-proj-..."},
        json={
            "model": "gpt-4o",
